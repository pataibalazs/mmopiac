              ...
              <div className="mx-auto max-w-5xl lg:text-center">
                ...
                <div className="flex flex-col items-center">
                  <p className="text-lg mt-6 font-normal mb-6 text-left w-10/12 ">
                    A játékbeli valuta megkapásához{" "}
                    <span className="font-bold">
                      kattints jobb alsó sarokban található kék chat ablak
                      ikonra
                    </span>
                    , ahol a felvesszük veled a kapcsolatot és megbeszéljük,
                    hogy hol találkozzunk a játékban.
                  </p>
                  <p className="text-lg font-normal mb-6 text-left w-10/12 ">
                    Nagyon fontos, hogy semmiképpen sem a játékban fogunk veled
                    kommunikálni, hanem az oldalon található chatablakon
                    keresztül. Tehát bárki ír rád a játékon belül a
                    tranzakcióval kapcsolatban valószínűleg rossz szándékkal
                    teszi.
                  </p>
                </div>
